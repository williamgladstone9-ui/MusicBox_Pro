...
echo "⛵ Installing BoatBox Pro from $ROOT"
...
echo "2. Start offline AP: sudo sh /srv/musicbox/scripts/boat-start.sh"
echo "3. Start services: sudo rc-service mpd start; sudo rc-service nginx start; sudo rc-service musicbox-web start"
echo "4. Open: http://boatbox.lan/captain or http://192.168.44.1/captain"
